...
```math
C_{\mu V} = \Delta Q / \Delta V = \Delta U / \Delta T
...
$$\oint \frac{ \overline D }{ \varepsilon _0 \varepsilon } dS = \sum _{ i=1 } ^{ n } Q_i =$$

$$= \frac{ 1 }{ \varepsilon _0 \varepsilon } \oint \overline D d \overline S$$
...
$$\oint _S \overline E d \overline S$$
...
![alt text](images/wavelengths.png)
