Механика
*Масса - это мера инертности вещества*
**F = ma**
**m = F / a**
...
*Концентрация - это количество вещества на единицу объема*

**n = N / V**

Определить концентрацию атомов меди находящихся в конденсированном состоянии используя знания плотности меди
...
***Радиус Земли составляет примерно 6 378,1***
...
Порядковый номер хим элемента определяется количеством протонов в ядре атома
...
**Изотоп - это различные варианты какого-либо хим элемента отличающиеся кол-вом нейтронов**

**Изотопы есть у каждого хим. элемента**

***Кол-во электронов в атоме точно равно кол-ву протонов поэтому атомы электрически нейтральны***

==ИОН - это атом потерявший или присоединивший один или несколько электронов==

**Вещество в ионизированном состоянии называется плазма**
...
*Переход из одного состояния в другое осуществляется при изменении соотношения потенциальной энергии взаимодействия молекул и их кинетической энергии движения*
...
3) Они взаисодействуют
Было сформировано понятие идеалтного газа где можно было пренебречь взаимодействием молекул

Сила - это мера взаимодействия

Молекулы в твердом и конденсируемом состоянии будут находится в определенном расстоянии друг от друга в связи с чем будет формироваться определенная концентрация и соответственно плотность

Если молекула 2 уйдет на расстояние в 10 раз больше чем r0 то вещество перейдет в газообразное состояние

Воздух находящийся при нормальном давлении и температуре можно считать идеальным газом

// дома читать все про давление //
// особенно опыт тричелли //

Нормальным считается давление в 1 атмосферу
